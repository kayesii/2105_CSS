 ...
 * @author Ivan
 */
public class PremiumBaptism extends javax.swing.JFrame {

    /**
     * Creates new form PremiumBaptism
     */
    public PremiumBaptism() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PremiumBaptism.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PremiumBaptism().setVisible(true);
            }
        });
    }
