...
public class BasicWedding extends javax.swing.JFrame {

    /**
     * Creates new form BasicWedding
     */
    public BasicWedding() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("Food Menu\nAppetizers: Vegetable sticks with dip, cheese platters\nSalads: Garden salad, coleslaw\nMain Dishes:\nGrilled chicken or roasted chicken\nPasta with tomato or creamy sauce\nFried fish fillets\nGarlic rice or steamed rice\nMixed sautéed vegetables\n\nSnacks\nAssorted pastries (e.g., cookies, mini cupcakes)\nSpring rolls\nChips and dips\n\nBeverages\nSoft drinks\nWater\nCoffee and tea\n\nSetting\nSeating: chairs with basic white covers\nTables:  tables with plain white tablecloths\nBuffet-style food station\n\nDecor\nModest floral centerpieces with seasonal flowers\nBasic lighting (soft warm tones)\nTable napkins in matching theme colors\nSimple backdrop for the couple’s table\nCandles for a cozy ambiance");
        jScrollPane1.setViewportView(jTextArea1);

        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 80, 540, 290));

        jLabel4.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel4.setText("BASIC WEDDING");
        ...
        jLabel2.setText("Timeless Love Package");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 390, 540, 60));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/basic wedding.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BasicWedding.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BasicWedding().setVisible(true);
            }
        });
    }
