...
public class BasicBaptism extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("sacred start package");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 390, 530, 60));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/basic baptism.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BasicBaptism.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BasicBaptism().setVisible(true);
            }
        });
    }
