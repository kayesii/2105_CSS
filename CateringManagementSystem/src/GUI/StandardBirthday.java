...
public class StandardBirthday extends javax.swing.JFrame {
    ...
    /**
     * Creates new form StandardBirthday
     */
    public StandardBirthday() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("Food:\n\nPizza\nSandwiches\nSoft drinks\nCake\nSnacks:\n\nFruit platters\nChips\nCookies\nBeverages:\n\nSoft drinks\nSetting:\n\nChairs with themed covers\nSimple tablecloths\nDecor:\n\nBalloon arrangements\nMinimal backdrop for photos\nDecorative banners\n");
        jScrollPane1.setViewportView(jTextArea1);

        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 80, 540, 290));

        jLabel4.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel4.setText("STANDARD BIRTHDAY");
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 340, -1, 50));
        ...
        jLabel2.setText("Festive Gathering package");
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/standard birthday.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StandardBirthday.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StandardBirthday().setVisible(true);
            }
        });
    }
