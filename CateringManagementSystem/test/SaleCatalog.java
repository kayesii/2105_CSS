...
CombinedTable.setModel(model);  // Set this model to the table
            ...
            while (rs.next()) {
                ...
                // Add the data to the table without the "Status" column
                model.addRow(new Object[]{transactionId, bookingId, reservationId, date, paymentamount, refundamount});

                // Calculate total sales
                totalSale += rs.getDouble("Paymentamount");
            }
